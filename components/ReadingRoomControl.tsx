...
import { Users, LogOut, BookOpen, MessageSquare } from 'lucide-react';
...
export default function ReadingRoomControl({ roomId, isHost, participantCount, hostName, currentUserId }: ReadingRoomControlProps) {
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handleLeave}
                disabled={isLeaving}
                className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-500 text-xs font-medium transition-colors disabled:opacity-50"
              >
