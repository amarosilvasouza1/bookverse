        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6 order-2 lg:order-1">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-white/5">
              <h3 className="text-lg font-bold text-white">{t('communityFeed')}</h3>
              <div className="flex gap-2">
                <button className="px-3 py-1 text-sm font-medium text-white bg-white/10 rounded-full">{t('latest')}</button>
                <button className="px-3 py-1 text-sm font-medium text-muted-foreground hover:text-white transition-colors">{t('top')}</button>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              {community.posts.length === 0 && (
                <div className="text-center py-16 text-muted-foreground glass-card rounded-2xl border-dashed border-2 border-white/10">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">{t('quietInHere')}</h3>
                  <p>{t('beTheFirst')}</p>
                </div>
              )}
            </div>
          ...
          <div className="lg:col-span-4 space-y-6 order-1 lg:order-2">
            ...
            <div className="glass-card p-6 rounded-2xl border border-white/10 bg-black/20 sticky top-24">
              ...
              <div className="mt-6 pt-6 border-t border-white/10">
                <h4 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3">{t('createdBy')}</h4>
                <div className="flex items-center gap-3">
